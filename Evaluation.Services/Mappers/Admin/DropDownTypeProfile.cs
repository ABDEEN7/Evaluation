...
namespace Evaluation.Services.Mappers.Admin
{
    ...
    public class DropDownTypeProfile : Profile
    {
        public DropDownTypeProfile()
        {
            CreateMap<DropDownType, DropDownTypeDTO>()
               ...
               .ForMember(d => d.Parent, opt => opt.MapFrom<ParentDropdownTypeResolver, Guid?>(src => src.ParentId));

        }

    }
    public class ParentDropdownTypeResolver : IMemberValueResolver<object, object, Guid?, string?>
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly RequestInfo _requestInfo;

        public ParentDropdownTypeResolver(IServiceProvider serviceProvider, RequestInfo requestInfo)
        {
