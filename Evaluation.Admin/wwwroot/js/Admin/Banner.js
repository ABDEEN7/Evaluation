...
const loadData = (isSearch) => {
    ...
    jqClientAdvanced(options).Get("Banner/GetAllBanner".concat('?page=', currentPage));
};
...
const deleteData = (id) => {
    ...
    notificationUtil.confirmation({ title: sharedFn().GetUiControlText('ADMIN_WARNING_DELETE'), okText: sharedFn().GetUiControlText('DELETE_BUTTON'), cancelText: sharedFn().GetUiControlText('ADMIN_CANCEL') }, result => {
        ...
        jqClientAdvanced(options).Post("Banner/DeleteBanner".concat('?Id=', id));
        ...
        columnResized: function (column) {
            ...
            const options = {
             ...
             jqClientAdvanced(options).PostFormData("Banner/UpdateBannerOrder", formData);
                    ...
                    if (data) {
                        ...
                        switch (responseStatus) {
                            ...
                            case 2:
                                ...
                                break;
                            case 9:
                                notificationUtil.error(sharedFn().GetUiControlText('BANNERS_EXCEEDED'));
